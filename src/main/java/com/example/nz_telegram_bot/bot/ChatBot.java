...
public class ChatBot extends TelegramLongPollingBot {
    ...
    private static final Logger LOGGER = LogManager.getLogManager().getLogger(String.valueOf(ChatBot.class));
    ...
    public void onUpdateReceived(Update update) {
        ...
        if (user == null) {
            ...
            LOGGER.info("Update receiver for user in state: " + state);
        }
    ...
    private boolean checkIfAdminCommand(User user, String text) {
        ...
        if (text.startsWith(BROADCAST)) {
            LOGGER.info("Admin command received: " + BROADCAST + " " + text);
